...
"""
Script to compare dataset stores generated by networkplanner library
...
def get_nx_graph(filename):
    ...
    nxg = networkplanner_runner.dataset_store_to_geograph(ds)
    return nxg
...
parser = argparse.ArgumentParser(description=
        "Compare 2 networkplanner dataset stores")
